...
public class PasswordView extends EditText {
    ...
    private int divideLineWidth1 = 2;
    /**
     * 竖直分割线的颜色
     */
    ...
    private void getAtt(AttributeSet attrs) {
        ...
        divideLineWidth1 = typedArray.getDimensionPixelSize(R.styleable.PayPsdInputView_divideLineWidth1, divideLineWidth1);
    ...
    private void initPaint() {
        ...
        borderPaint = getPaint(divideLineWidth1, Paint.Style.STROKE, borderColor);
    ...
    private void drawWeChatBorder(Canvas canvas) {
        ...
        for (int i = 0; i < maxCount - 1; i++) {
            canvas.drawLine((i + 1) * divideLineWStartX, 0, (i + 1) * divideLineWStartX, height, divideLinePaint);
        }
    }
