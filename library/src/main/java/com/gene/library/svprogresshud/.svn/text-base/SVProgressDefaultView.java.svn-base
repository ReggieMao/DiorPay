package com.gene.library.svprogresshud;
...
public class SVProgressDefaultView extends LinearLayout {
    ...
    private int resBigLoading = com.gene.library.R.mipmap.ic_svstatus_loading;
    private int resInfo = com.gene.library.R.mipmap.ic_svstatus_info;
    private int resSuccess = com.gene.library.R.mipmap.ic_svstatus_success;
    private int resError = com.gene.library.R.mipmap.ic_svstatus_error;
    ...
    private void initViews() {
        LayoutInflater.from(getContext()).inflate(com.gene.library.R.layout.view_svprogressdefault, this, true);
        ivBigLoading = (ImageView) findViewById(com.gene.library.R.id.ivBigLoading);
        ivSmallLoading = (ImageView) findViewById(com.gene.library.R.id.ivSmallLoading);
        circleProgressBar = (SVCircleProgressBar) findViewById(com.gene.library.R.id.circleProgressBar);
        tvMsg = (TextView) findViewById(com.gene.library.R.id.tvMsg);
    }
