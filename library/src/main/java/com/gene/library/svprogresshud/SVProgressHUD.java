...
public class SVProgressHUD {
    ...
    protected void initViews() {
        ...
        rootView = (ViewGroup) layoutInflater.inflate(com.gene.library.R.layout.layout_svprogresshud, null, false);
    ...
    private void setMaskType(SVProgressHUDMaskType maskType) {
        ...
        switch (mSVProgressHUDMaskType) {
            ...
            case ClearCancel:
                ...
                break;
            case Black:
                configMaskType(com.gene.library.R.color.bgColor_overlay, true, false);
                break;
            case BlackCancel:
                configMaskType(com.gene.library.R.color.bgColor_overlay, true, true);
                break;
            case Gradient:
                configMaskType(com.gene.library.R.drawable.bg_overlay_gradient, true, false);
                break;
            case GradientCancel:
                configMaskType(com.gene.library.R.drawable.bg_overlay_gradient, true, true);
                break;
            default:
                break;
        }
    ...
    private void setCancelable(boolean isCancelable) {
        View view = rootView.findViewById(com.gene.library.R.id.sv_outmost_container);
